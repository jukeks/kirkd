...
object ServerMessage {
    fun serialize(message: Message): String {
        val line = when (message) {
            ...
            is Message.Cap -> ":${message.prefix} CAP * ${message.subcommand} :${message.params.joinToString(" ")}"
            is Message.Welcome -> ":${message.prefix} 001 ${message.nick} :Welcome to the Internet Relay Network ${message.nick}"
